...
import com.example.android.sunshine.app.wear.WearServiceListener;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if (cVVector.size() > 0) {
                ...
                updateMuzei();
                notifyWeather();
                getContext().startService(new Intent(getContext(), WearServiceListener.class));
            }
        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    Bitmap largeIcon = getArtIcon(weatherId);
                    ...
                    String contentText = String.format(context.getString(R.string.format_notification),
                            desc,
                            Utility.temperatureFormat(context, high),
                            Utility.temperatureFormat(context, low));
    ...
    private Bitmap getArtIcon(int weatherId) {
        Context context = getContext();
        Resources resources = context.getResources();
